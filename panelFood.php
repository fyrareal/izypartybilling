<div class="row" style="margin:50px;">
    ...
    <div class="col-md-5">
<!--         <h2 style="text-align:center;margin:0;margin-bottom:20px;">Foods & Drinks Add Section</h2>-->
  <h1 style="text-align:center;color:white;background-color:orange;margin:0;"><strong>Food</strong><span>&nbsp;Section</span></h1>
